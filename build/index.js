...
var FormatedData_1 = require("./FormatedData");
var NewData_1 = require("./NewData");
var fileData = new FormatedData_1.FormatedData('football.csv');
console.log(fileData.read());
console.log('************************************************');
var newData = new NewData_1.NewData('football.csv');
